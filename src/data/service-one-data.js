const ServiceOneData = [
  {
    ...
    des: (
      <>
        - консультація невролога-вертебролога <br />
        - консультація ортопеда-травматолога <br />
        - консультація мануального терапевта <br />
  ...
  },
  {
    ...
    des: (
      <>
        - Лікувальний масаж шийно-комірцевої зони та грудного відділу хребта
